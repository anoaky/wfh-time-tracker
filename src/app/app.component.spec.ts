...
describe("AppComponent", () => {
    ...
    it("should save to localStorage when adding project", () => {
        ...
        expect(savedData).toEqual([{ name: "Test Project", elapsedTime: 0, hourlyRate: 0 }]);
    });
    ...
    it("should save to localStorage when project time changes", () => {
        ...
        const savedData = JSON.parse(mockLocalStorage["wfhProjects"]);
        expect(savedData).toEqual([{ name: "Timer Project", elapsedTime: 60, hourlyRate: 0 }]);
    });
    ...
    it("should display empty state when no projects", () => {
        ...
        expect(emptyStateHeading?.textContent).toContain(
    ...
    it("should pass correct inputs to project items", () => {
        ...
        const projectItemDebugEl = fixture.debugElement.query(
            By.css("project-item"),
        );
    ...
    it("should handle multiple projects with different elapsed times", () => {
        ...
        expect(savedData).toEqual([
            { name: "Project 1", elapsedTime: 100, hourlyRate: 0 },
            { name: "Project 2", elapsedTime: 200, hourlyRate: 0 },
            { name: "Project 3", elapsedTime: 300, hourlyRate: 0 },
        ]);
    });
    ...
    it("should update localStorage after deletion", () => {
        ...
        const savedData = JSON.parse(mockLocalStorage["wfhProjects"]);
        expect(savedData).toEqual([{ name: "Project to Keep", elapsedTime: 0, hourlyRate: 0 }]);
    });
    ...
    it("should provide project names to add-project-form", () => {
        ...
        const addFormComponent = fixture.debugElement.query(
            By.css("app-add-project-form"),
        );
        expect(addFormComponent.componentInstance.existingProjectNames()).toEqual([
            "Project A",
            "Project B",
        ]);
    });
